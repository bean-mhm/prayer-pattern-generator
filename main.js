...
var Param = /** @class */ (function () {
    ...
    Param.prototype.render_from_scratch = function () {
        ...
        if (typeof this._value === "number") {
            var input_1 = elem.appendChild(document.createElement("input"));
            input_1.className = "control";
            input_1.type = "range";
            input_1.min = (this._config.min || 0.).toString();
            input_1.max = (this._config.max || 1.).toString();
            input_1.step = (this._config.step || .001).toString();
            input_1.value = this._value.toString();
    ...
    Param.prototype.render = function () {
        ...
        if (typeof this._value === "number") {
            var input = this._element.getElementsByTagName("input")[0];
...
function init() {
    // add parameters
    param_list.add(new Param("tile_size", "Tile Size", new Vec2(200., 400.), "use-id", function () { return render_canvas(); }, null, { min: 10., max: 1000., step: 1. }));
    param_list.add(new Param("border_thickness", "Border Thickness", 3., "use-id", function () { return render_canvas(); }, null, { min: 0., max: 20., step: .25 }));
    param_list.add(new Param("grid_lines_density", "Density", 400., "use-id", function () { return render_canvas(); }, null, { min: 1., max: 2000., step: 1. }));
    param_list.add(new Param("grid_lines_thickness", "Thickness", 1., "use-id", function () { return render_canvas(); }, null, { min: 0., max: 20., step: .25 }));
    param_list.add(new Param("grid_lines_opacity_horizontal", "Horizontal Lines", 0., "use-id", function () { return render_canvas(); }, null, { min: 0., max: 1., step: .001 }));
    param_list.add(new Param("grid_lines_opacity_vertical", "Vertical Lines", .05, "use-id", function () { return render_canvas(); }, null, { min: 0., max: 1., step: .001 }));
    param_list.add(new Param("masjad_position", "Position", .125, "use-id", function () { return render_canvas(); }, null, { min: 0., max: .5, step: .001 }));
    param_list.add(new Param("masjad_radius", "Radius", .05, "use-id", function () { return render_canvas(); }, null, { min: 0., max: .5, step: .001 }));
    param_list.add(new Param("feet_vertical_position", "Position", .2, "use-id", function () { return render_canvas(); }, null, { min: 0., max: .5, step: .001 }));
    param_list.add(new Param("feet_horizontal_distance", "Distance", .12, "use-id", function () { return render_canvas(); }, null, { min: 0., max: .3, step: .001 }));
    param_list.add(new Param("feet_thickness", "Thickness", 1., "use-id", function () { return render_canvas(); }, null, { min: 0., max: 20., step: .25 }));
    param_list.add(new Param("feet_opacity", "Opacity", 1., "use-id", function () { return render_canvas(); }, null, { min: 0., max: 1., step: .001 }));
    param_list.add(new Param("feet_size", "Size", new Vec2(.05, .13), "use-id", function () { return render_canvas(); }, null, { min: 0., max: .3, step: .001 }));
    param_list.add(new Param("transform_scale", "Scale", new Vec2(1., 1.), "use-id", function () { return render_canvas(); }, null, { min: .1, max: 3., step: .001 }));
    param_list.add(new Param("transform_skew", "Skew", new Vec2(0., 0.), "use-id", function () { return render_canvas(); }, null, { min: -1., max: 1., step: .001 }));
    param_list.add(new Param("transform_rotation", "Rotation", 0., "use-id", function () { return render_canvas(); }, null, { min: -180., max: 180., step: .001 }));
    param_list.add(new Param("transform_offset", "Offset", new Vec2(0., 0.), "use-id", function () { return render_canvas(); }, null, { min: -200., max: 200., step: .25 }));
    param_list.add(new Param("background_color_h", "Hue", 0., "use-id", function () { update_color_blobs(); render_canvas(); }, function () { return update_color_blobs(); }, { min: 0., max: 1., step: .001 }));
    param_list.add(new Param("background_color_s", "Saturation", 0., "use-id", function () { update_color_blobs(); render_canvas(); }, function () { return update_color_blobs(); }, { min: 0., max: 1., step: .001 }));
    param_list.add(new Param("background_color_v", "Value", 0., "use-id", function () { update_color_blobs(); render_canvas(); }, function () { return update_color_blobs(); }, { min: 0., max: 1., step: .001 }));
    param_list.add(new Param("pattern_color_h", "Hue", 0., "use-id", function () { update_color_blobs(); render_canvas(); }, function () { return update_color_blobs(); }, { min: 0., max: 1., step: .001 }));
    param_list.add(new Param("pattern_color_s", "Saturation", 0., "use-id", function () { update_color_blobs(); render_canvas(); }, function () { return update_color_blobs(); }, { min: 0., max: 1., step: .001 }));
    param_list.add(new Param("pattern_color_v", "Value", 1., "use-id", function () { update_color_blobs(); render_canvas(); }, function () { return update_color_blobs(); }, { min: 0., max: 1., step: .001 }));
